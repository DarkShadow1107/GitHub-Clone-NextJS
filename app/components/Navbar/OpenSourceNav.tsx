...
const OpenSourceNav = (props: Props) => {
  ...
  return (
        <li id='myLi'  onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} >
            ...
            <div className={`relative lg:absolute -ml-5 bg-gray-900 rounded-md lg:py-4 p-6 w-[320px] transition ease-in duration-150 ${show ? "opacity-100 visible" : "opacity-0 hidden"}`}>
                <div className='lg:border-b-[1px] mb-4 pb-6 pt-4 w-full'>
                    <span className='text-neutral-100 font-semibold text-base hover:text-blue-300'> GitHub Sponsers <p className='text-sm font-normal text-neutral-400'>Fund open source developers</p></span>
                </div>
                <div className='lg:border-b-[1px] mb-4 pb-6 pt-0 w-full'>
                    <span className='text-neutral-100 font-semibold text-base hover:text-blue-300'>The ReadMe Projects <p className='text-sm font-normal text-neutral-400'>GitHub community articles</p></span>
                </div>
                <div className='mb-4 pb-0 pt-2 w-full'>
                    <span className='text-neutral-100 font-semibold text-base'>Repositories</span>
                    <ul className='text-sm text-neutral-400 mt-1 w-full'>
                        <li >
                            <a href="" className='block py-2 hover:text-blue-300'>Topics</a>
                        </li>
                        <li >
                            <a href="" className='block py-2 hover:text-blue-300'>Trendings</a>
                        </li>
                        <li >
                            <a href="" className='block py-2 hover:text-blue-300'>Collections</a>
                        </li>
                    </ul>
                </div>
            </div>
