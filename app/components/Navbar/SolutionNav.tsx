...
const SolutionNav = (props: Props) => {
  ...
  return (
    <li onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
        ...
        <div className={`relative lg:absolute -ml-5 bg-gray-900 rounded-md lg:py-4 p-6 w-[300px] transition ease-in duration-300 ${show ? "opacity-100 " : "opacity-0 hidden top-[2000px]"}`}>
            <div className='lg:border-b-[1px] mb-4 pb-4 pt-4 w-full'>
                <span className='text-neutral-100 font-semibold text-base'>For</span>
                <ul className='text-sm text-neutral-400 mt-1 w-full'>
                    <li >
                        <a href="" className='block py-2 hover:text-blue-300'>Enterprise</a>
                    </li>
                    <li>
                        <a href="" className='block py-2 hover:text-blue-300'>Teams</a>
                    </li>
                    <li >
                        <a href="" className='block py-2 hover:text-blue-300'>Startups</a>
                    </li>
                    <li className='py-2'>
            ...
            <div className='lg:border-b-[1px] mb-4 pb-4 pt-2 w-full'>
                <span className='text-neutral-100 font-semibold text-base'>By Solution</span>
                <ul className='text-sm text-neutral-400 mt-1 w-full'>
                    <li >
                        <a href="" className='block py-2 hover:text-blue-300'>CI/CD & Automation</a>
                    </li>
                    <li className='py-2'>
            ...
            <div className='mb-4 pb-0 pt-2 w-full'>
                <span className='text-neutral-100 font-semibold text-base'>Case Studies</span>
                <ul className='text-sm text-neutral-400 mt-1 w-full'>
                    <li >
                        <a href="" className='block py-2 hover:text-blue-300'>Customer stories</a>
                    </li>
                    <li className='py-2'>
